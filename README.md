...
## P.S.
Сохранение изображений происходит через firestore как base64 строка, потому что тз включало в себя обязательное хранение картинок в firebase, но firebase storage платный :s(
